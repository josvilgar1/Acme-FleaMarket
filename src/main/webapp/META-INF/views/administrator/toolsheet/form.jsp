...
<acme:form>
	...
	<acme:form-submit test="${command == 'show'}" 
		code="administrator.toolsheet.form.button.update" 
		action="/administrator/toolsheet/update"/>
	<acme:form-submit test="${command == 'show'}" 
		code="administrator.toolsheet.form.button.delete" 
		action="/administrator/toolsheet/delete"/>
	...
	<acme:form-submit test="${command == 'delete'}" 
		code="administrator.toolsheet.form.button.delete" 
		action="/administrator/toolsheet/delete"/> 
  	<acme:form-return code="administrator.toolsheet.form.button.return"/>
</acme:form>
