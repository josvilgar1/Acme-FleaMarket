...
<acme:form readonly="true">
	<acme:form-textbox code="authenticated.auditrecord.form.label.item" path="item.title"/>
	<acme:form-textbox code="authenticated.auditrecord.form.label.title" path="title"/>
	<acme:form-textbox code="authenticated.auditrecord.form.label.auditor.firm" path="auditor.firm"/>
	<jstl:if test="${command != 'create'}">
		<acme:form-moment code="authenticated.auditrecord.form.label.creationMoment" 
			path="creationMoment" 
			readonly="true"/>
	</jstl:if>
