...
@Service
public class AdministratorMaterialDeleteService implements AbstractDeleteService<Administrator, Material> {
	...
	@Override
	public void delete(Request<Material> request, Material entity) {
